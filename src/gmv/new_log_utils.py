...
class LoggerFactory(object):
    ...
    def setup_simple_stderr_handler(cls):
        ...
        if type == "STANDALONE":
            ...
            cls._factory.setup_simple_stderr_handler()
    ...
    def setup_simple_stdout_handler(cls):
        ...
        if type == "STANDALONE":
            cls._factory = LogbookLoggerFactory()
            cls._factory.setup_simple_stdout_handler()
    ...
    def setup_simple_file_handler(cls, type, file_path):
        ...
        if type == "STANDALONE":
            cls._factory = LogbookLoggerFactory()
            cls._factory.setup_simple_file_handler(file_path)
    ...
    def setup_cli_app_handler(cls, type, activate_log_file=False, console_level= 'CRITICAL', file_path=DEFAULT_LOG, log_file_level = 'DEBUG'):
        ...
        if type == "STANDALONE":
            cls._factory = LogbookLoggerFactory()
            cls._factory.setup_cli_app_handler(activate_log_file=False, console_level= 'CRITICAL', file_path=DEFAULT_LOG, log_file_level = 'DEBUG')
